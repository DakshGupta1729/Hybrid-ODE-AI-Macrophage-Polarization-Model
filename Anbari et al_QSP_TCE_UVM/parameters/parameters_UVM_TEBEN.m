...
function params = parameters_UVM_TEBEN
...
%% Cancer Parameters
% Growth Rate
params.k_C_growth.Value = 0.002;
params.k_C_growth.Units = '1/day';
params.k_C_growth.Notes = '(char 1997, doi:10.1001/archopht.1997.01100160184007)';
% Death Rate
...
params.C_max.Value = 7.5e10; 
params.C_max.Units = 'cell';
params.C_max.Notes = 'estimated';
% Initial Tumour Diameter
params.initial_tumour_diameter.Value = 1.1;  %11mm%
params.initial_tumour_diameter.Units = 'centimeter';
params.initial_tumour_diameter.Notes = '(Wald 2017, PMID: 28843360; Castro 2022, PMID: 35331553)';
% Cancer Cell Density
...
params.n_clones_tum.Value = 17;
params.n_clones_tum.Units = 'dimensionless';
params.n_clones_tum.Notes = '(bertrand 2016 doi: 10.1016/j.ajhg.2016.09.008.)';
% Self-antigen-specific T cell clone number
params.n_clones_slf.Value = 17;
...
% Rate of T Cell Death by Tregs      
params.k_Treg_TCE.Value = 0.1; 
params.k_Treg_TCE.Units = '1/day';
params.k_Treg_TCE.Notes = '(guess)';
...
params.T8_PD1.Value = 3.1e3*20*0.1;
...
params.T8_PDL1.Value = 9.3e3*20*0.1;
...
params.C_PDL1.Value = 1.8e4;
params.C_PDL1.Units = 'molecule';
params.C_PDL1.Notes = '(Basile1 2019  https://doi.org/10.1371/ journal.pone.0210276)';
% Average Baseline PDL1 Expression on mAPCs in TDLN
params.APC_PDL1.Value = 1.8e4;
params.APC_PDL1.Units = 'molecule';
params.APC_PDL1.Notes = '(Basile1 2019  https://doi.org/10.1371/ journal.pone.0210276)';
...
%% Paclitaxel PD Parameters & Gompertzian growth
...
params.k_K_d.Value = 3.4e-3; % 2.3e-3
...
params.c_vas_50.Value = 1.07e3; % 839
...
params.k_M2_pol.Value = 0.4; %0.25%
...
params.k_M1_pol.Value = 0.001; %0.02%
...
params.C_CD47.Value = 500;
params.C_CD47.Units = 'molecule/micrometer^2';
params.C_CD47.Notes = '(Basile1 2019  https://doi.org/10.1371/ journal.pone.0210276)';
...
% Surface area of the synapse
params.T_syn.Value = 37.8*2;
params.T_syn.Units = 'micrometer^2';
params.T_syn.Notes = '(Janssen 2007)';
% The synapse gap distance (kd 2D = kd3D*d_syn)
params.dT_syn.Value = 3.0;
params.dT_syn.Units = 'nanometer';
params.dT_syn.Notes = '(Janssen 2007)';
% Death Rate Due to TCEs activated T Cells
params.k_C_BTcell.Value = 10;   %1
params.k_C_BTcell.Units = '1/day';
params.k_C_BTcell.Notes = '(assumed)';
% Death Rate Due to TCEs activated Tregs
params.k_C_BTreg.Value = 10;    %1
params.k_C_BTreg.Units = '1/day';
params.k_C_BTreg.Notes = '(assumed)';


%tebentafusb
% Internalization rate
params.kint.Value = 1e-3;
params.kint.Units = '1/second';
params.kint.Notes = '(Weddell 2023, doi.org/10.1002/psp4.12928)';
% gp100-teben kd
params.kd_gp100_teben.Value = 0.024;
params.kd_gp100_teben.Units = 'nanomolarity';
params.kd_gp100_teben.Notes = '(Weddell 2023, doi.org/10.1002/psp4.12928)';
% gp100-teben kon
params.kon_gp100_teben.Value = 1e-2;
params.kon_gp100_teben.Units = '1/(nanomolarity*second)';
params.kon_gp100_teben.Notes = '(guess)';
% CD3-teben kd
params.kd_CD3_teben.Value = 38;
params.kd_CD3_teben.Units = 'nanomolarity';
params.kd_CD3_teben.Notes = '(Weddell 2023, doi.org/10.1002/psp4.12928)';
% CD3-teben kon
params.kon_CD3_teben.Value = 1e-5;
params.kon_CD3_teben.Units = '1/(nanomolarity*second)';
params.kon_CD3_teben.Notes = '(guess)';

% CD3 Expression on Teff Cells
params.T8_CD3.Value = 100000;
params.T8_CD3.Units = 'molecule';
params.T8_CD3.Notes = '(Weddell 2023, doi.org/10.1002/psp4.12928)';
% CD3 Expression on Treg Cells
params.T4_CD3.Value = 100000;
params.T4_CD3.Units = 'molecule';
params.T4_CD3.Notes = '(Weddell 2023, doi.org/10.1002/psp4.12928)';
% gp100 Expression on cancer Cells
params.T8_gp100.Value = 100000;
params.T8_gp100.Units = 'molecule';
params.T8_gp100.Notes = '(Weddell 2023, doi.org/10.1002/psp4.12928)';
% gp100 Expression on APCs
params.APC_gp100.Value = 100000;
params.APC_gp100.Units = 'molecule';
params.APC_gp100.Notes = '(Weddell 2023, doi.org/10.1002/psp4.12928)';
% TCEs Concentration for Half-Maximal T Cell Killing
params.gp100_CD3_50.Value = 1; %8
params.gp100_CD3_50.Units = 'molecule/micrometer^2';
params.gp100_CD3_50.Notes = '(Jonathan 2016)';
% Hill Coefficient for CD19/CD3
params.n_gp100_CD3.Value = 4;
params.n_gp100_CD3.Units = 'dimensionless';
params.n_gp100_CD3.Notes = '(estimated!)';