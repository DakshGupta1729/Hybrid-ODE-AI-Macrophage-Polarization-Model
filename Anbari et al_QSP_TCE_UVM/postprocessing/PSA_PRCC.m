...
[rho,pval,~] = PRCC(params_in.all(index,:), params_out.post(index,:), 1, namesIn, alpha); %CHANGE : FOR IN params_out.post(index,:) DEPENDING ON HOW MANY POUTPUT PARAMTER YOU WANT TO PLOT
