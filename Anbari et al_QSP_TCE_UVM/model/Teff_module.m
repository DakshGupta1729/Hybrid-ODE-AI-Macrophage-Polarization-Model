...
if (first_call)
    ...
    addrule(model,'N_aT = N0 + N_IL2_CD8*V_LN.IL2/(IL2_50+V_LN.IL2)','repeatedAssignment');
    ...
    addrule(model,'N_aT0 = N0 + N_IL2_CD4*V_LN.IL2/(IL2_50+V_LN.IL2)','repeatedAssignment');
end
