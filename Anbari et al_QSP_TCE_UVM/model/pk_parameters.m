...
switch (name)
    ...
    case 'cibisatamab'
        ...
        gamma_T.Value = 0.522;% colorectal cancer
        gamma_T.Notes = '(Coughlin 2010)';
        gamma_LN.Value = 0.2;%fixed
        gamma_LN.Notes = '()';
    ...
    case 'tebentafusp'
        ...
        q_P.Value = 1.3e-4;
        q_P.Units = 'liter/second';
        q_P.Notes = '(Weddell 2023, doi.org/10.1002/psp4.12928)';
        % Central to Tumour
        q_T.Value = 1e-3;
        q_T.Units = '1/second';
        q_T.Notes = '(Weddell 2023, doi.org/10.1002/psp4.12928)';
        % Central to LN
        q_LN.Value = 3.25e-6;
        q_LN.Units = 'milliliter/second';
        q_LN.Notes = '(Meijer 2017, PMID: 28510992)';
        ...
        k_cl.Value = 9.95;
        k_cl.Units = 'liter/day';
        k_cl.Notes = '(fitted to carvajal 2022; PMID:35254876)';
        % Volume Fractions
        gamma_C.Value = 0.89;
        gamma_C.Notes = '(fitted to carvajal 2022; PMID:35254876)';
        gamma_P.Value = 0.02;
        gamma_P.Notes = '(fitted to carvajal 2022; PMID:35254876)';
        gamma_T.Value = 0.522;
        gamma_T.Notes = '(Coughlin 2010, PMID: 20125040; Finley 2015, PMID: 26783500)';
        gamma_LN.Value = 0.2;
        gamma_LN.Notes = '(Wang 2019, PMID: 31218069)';
